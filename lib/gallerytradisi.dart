...
import 'package:kebudayaan/gallerytradisidetail.dart';
...
class GalleryTradisi extends StatefulWidget {
  const GalleryTradisi({super.key});

  @override
  State<GalleryTradisi> createState() => _GalleryTradisiState();
}
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => GalleryTradisiDetail(data)),
                        );
                      },
                      child: Card(
                        child: Column(
