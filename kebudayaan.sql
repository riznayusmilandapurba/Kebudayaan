...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2024 at 06:52 PM
...
(1, 'Tor Tor (Tarian Tradisional Batak)', 'Tor Tor adalah tarian tradisional suku Batak yang penuh dengan makna dan simbolisme. Tarian ini biasanya dipentaskan dalam berbagai acara adat dan keagamaan, seperti upacara adat, perayaan hari besar, dan ritual keagamaan. Gerakan dalam tarian Tor Tor sering kali menggambarkan kehidupan sehari-hari, mitologi, atau nilai-nilai budaya suku Batak. Musik yang mengiringi tarian ini biasanya dimainkan dengan alat musik tradisional Batak seperti gondang, taganing, dan seruling.', ''),
...
--
-- Table structure for table `warisanseni`
--
...
--
-- AUTO_INCREMENT for table `tradisi`
--
ALTER TABLE `tradisi`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT for table `warisanseni`
--
ALTER TABLE `warisanseni`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
